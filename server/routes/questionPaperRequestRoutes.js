...
const uploadQuestionPaperRequest = getUploadMiddleware('question-papers');

router.post('/', protectUser, uploadQuestionPaperRequest.single('file'), submitQuestionPaperRequest);
